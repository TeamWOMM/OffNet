...
import {Activity, ArrowUpRight, CheckCircle2, Coins, MessageSquare, Plus, Target, X} from 'lucide-react';
...
///////////////
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    className="absolute w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-3xl animate-pulse -top-48 -left-48"/>
                <div
                    className="absolute w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-3xl animate-pulse -bottom-48 -right-48"/>
                <div
                    className="absolute w-[800px] h-[800px] bg-purple-500/5 rounded-full blur-3xl animate-pulse top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"/>
            </div>
            ...
            <header className="bg-gray-900/50 backdrop-blur-lg border-b border-gray-800 p-4 relative z-10">
                <nav className="flex justify-between items-center max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center space-x-4">
                        <div
                            className="flex items-center bg-gray-800/80 px-4 py-2 rounded-full border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300">
                            <Coins className="text-purple-400 w-5 h-5 mr-2"/>
                            <span className="font-semibold text-white">2,500</span>
                        </div>
                    </div>
                        ...
                        <div className="space-y-2">
                            {[
                                ...
                                >
                                    ...
                                    <div className="flex justify-between text-xs">
                                        <span
                                            className="text-purple-400 group-hover:text-purple-300">{chat.feature}</span>
                                        <span
                                            className="text-gray-500 group-hover:text-gray-400">{chat.timestamp}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
...
function ActivityCard({metrics, dailyGoals, onAddGoal, onToggleGoal, onViewDetails}) {
    ...
    return (
        <div
            className="bg-gray-900/50 backdrop-blur-lg border border-gray-800 rounded-xl p-4 mb-4 hover:border-purple-500/50 transition-all duration-300">
